<div class="row">
    <div id="background">
        <div class="row">
            <div class="col-8 offset-2 container" id="wrapper">
                <div class="row">
                    <div class="col-12">
                        <form class="col-12" id="uploadForm" method="post" action="{{url('app/upload')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12" id="title">
                                    <div class="col-11"><p>Select files to Upload</p></div>
                                    <div class="col-1 closeButton" id="smallExit" title="Close uploader"><i class="icon icon-cancel"></i></div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12" id="selectGroup">
                                        ...
                                        <div class="col-2">
                                            <input type="submit" class="btn btn-outline-primary disabled" title="Begin uploading" value="Upload" id="submit">
                                        </div>
                                    </div>
                                </div>
                            </div>
